...
func TestBuildPlanDeterministicIndependentReadyBranchesAndPure(t *testing.T) {
	...
	// its own terms.
	want := []ProposedTask{
		{WorkflowRunID: "run", Project: "project", TaskID: "task-alpha", AttemptID: "alpha-1", WorkerID: "worker-a"},
		{WorkflowRunID: "run", Project: "project", TaskID: "task-beta", AttemptID: "beta-1", WorkerID: "worker-a"},
	}
