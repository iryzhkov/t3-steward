...
that rubric as the standard your file is held to. Two things follow. The review
is about evidence, so state what you read and where, and mark what you could not
determine rather than covering it over. And the review is not a negotiation: do
not address the overseer in your file, do not argue for acceptance in it, and do
...
stray edit fails the task and blocks the gate.
